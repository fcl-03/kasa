  ...
  return (
    <main className="about">
      ...
      <div
          ...
          aria-label="Paysage de montagne"
        />
      ...
      <div className="about__collapses">
        ...
        <Collapse title="Sécurité">
          <p>
            ...
            critères de sécurité établis par nos services. En laissant une note aussi bien à l'hôte qu'au locataire, cela permet à nos 
            équipes de vérifier que les standards sont bien respectés. Nous organisons également des ateliers sur la sécurité domestique 
            pour nos hôtes.
          </p>
        </Collapse>
      </div>
